...
| T4.4 | 路由层（app_id, chat_id → ws_id） | ⚪ 未开始 | P0 | — | — |
| T4.5 | 即时 Thinking 反馈 | ⚪ 未开始 | P0 | — | — |
| T4.6 | 富卡片渲染器 | ⚪ 未开始 | P0 | — | — |
| T4.7 | 引用回复解析与注入 | ⚪ 未开始 | P0 | — | — |
| T5.1 | LLM Provider 抽象层 | ⚪ 未开始 | P0 | — | — |
| T5.2 | Agentic Loop 主体 | ⚪ 未开始 | P0 | — | — |
| T5.3 | System Prompt 构建 | ⚪ 未开始 | P0 | — | — |
| T5.4 | Session / Run 管理（1:1） | ⚪ 未开始 | P0 | — | — |
| T5.5 | 内置工具实现（只读类） | ⚪ 未开始 | P0 | — | — |
| T5.6 | 内置工具实现（写类 + Bash） | ⚪ 未开始 | P0 | — | — |
| T5.7 | Skill 工具（按需 invoke） | ⚪ 未开始 | P0 | — | — |
| T5.8 | MCP 客户端 | ⚪ 未开始 | P1 | — | — |
| T5.9 | 子代理（Agent 工具）+ 并行执行 | ⚪ 未开始 | P0 | — | — |
| T5.10 | 上下文管理（自研四道防线） | ⚪ 未开始 | P0 | — | — |
| T6.1 | WS 写锁（Redis 分布式锁） | ⚪ 未开始 | P0 | — | — |
